module.exports = function(app) {
    ...
    app.get('/admin/excluir/:idUsuario', function (req, res){
        app.app.controller.admin.excluir_usuario(app,req,res)
    })

    app.get('/admin/excluir_produto/:idProduto', function (req, res){
